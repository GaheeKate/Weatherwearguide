...
app.get("/", async (request, response) => {
  ...
  response.render("index", { title: "Home", menu: menus, link: links, weather: weathers });
...
app.get("/result", async (request, response) => {
  try {
    ...
    const menus = await getList();
    response.render("result", { title: "Result", menu: menus, link: links, weather, outfit, image });
...
app.post("/result", async (request, response) => {
  try {
    ...
    const menus = await getList();
    response.render("result", { title: "Home", menu: menus, link: links, weather, outfit, image });
